 ...
 * @author Admin
 */
@WebServlet(name = "sua_loai_san_pham_admin", urlPatterns = {"/sua_loai_san_pham"})
public class sua_loai_san_pham_admin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet sua_loai_san_pham_admin</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet sua_loai_san_pham_admin at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        lsp.setMa_loai(ma_loai);
        
        try {
            lq.Update_loai_san_pham(lsp);
