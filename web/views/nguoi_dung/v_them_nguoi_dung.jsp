...
<div id="page-wrapper">
    ...
    <form method="post"  action="them_nguoi_dung">
        <fieldset>
          
          <p>
              <label class="alert">Họ tên </label>
            <input class="text-input small-input kiemtra" type="text" id="ho_ten" name="ho_ten" />
          </p>
           ...
           <p>
            ...
            <input class="text-input small-input kiemtra" type="password" id="mat_khau" name="mat_khau" />
          </p>
          
           <p>
              <label class="alert">Email </label>
            <input class="text-input small-input kiemtra" type="email" id="email" name="email" />
          </p>
